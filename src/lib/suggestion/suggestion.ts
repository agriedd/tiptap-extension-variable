		...
		state: {
			...
			apply(transaction, prev, _oldState, state) {
				...
				if (isEditable && (empty || editor.view.composing)) {
					...
					console.log("tidak bisa diedit atau selection tidak kosong");
					// periksa jika dalam keadaan sedang memilih komponen
					console.log("🚀 ~ apply ~ empty, from, to:", empty, from, to)
					next.active = false
				}
